...
def build_xai_header(features: EmailFeatures, spam_prob: float,
    ...
    if spam_prob > 0.30:
        ...
        # SPF/DKIM are intentionally omitted here. The raw MIME headers can be
        # forged; only receiver-verified authentication results may produce an
        # authentication explanation in the dashboard.
