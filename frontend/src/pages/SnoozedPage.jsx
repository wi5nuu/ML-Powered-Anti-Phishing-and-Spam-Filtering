    ...
    <GmailShell>
      <div style={{ padding: '24px', fontFamily: 'Google Sans, Roboto, sans-serif' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
          ...
          <h1 style={{ fontSize: '1.5rem', fontWeight: 500, margin: 0 }}>Email Ditunda (Snoozed)</h1>
        </div>
        ...
        <div style={{
          ...
          <h3 style={{ margin: '0 0 8px 0', fontWeight: 500, color: 'var(--text)' }}>Tidak ada email ditunda</h3>
          <p style={{ margin: 0, fontSize: '0.875rem', maxWidth: '360px' }}>
            Tunda email di halaman detail email untuk memindahkannya sementara waktu dari kotak masuk Anda.
          </p>
        </div>
      </div>
    </GmailShell>
