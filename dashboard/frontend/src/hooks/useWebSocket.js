...
export function useWebSocket({ enabled = false, mailboxEmail = '' } = {}) {
  ...
  useEffect(() => {
    if (!enabled || !mailboxEmail) return undefined
  ...
  }, [enabled, mailboxEmail, showToast, qc])
}
