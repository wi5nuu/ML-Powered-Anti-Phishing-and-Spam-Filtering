...
const ROLE_COLORS = { admin: '#2563EB', user: '#059669' }
const ROLE_BG = { admin: '#EFF6FF', user: '#ECFDF5' }
      ...
      <div className={styles.toolbar}>
        ...
        <div className={styles.filterGroup}>
          ...
          <button
            ...
            style={statusFilter === 'all' ? { background: '#1a73e8', color: '#fff' } : {}}
          ...
          <button
            ...
            style={statusFilter === 'active' ? { background: '#34a853', color: '#fff' } : {}}
          ...
          <button
            ...
            style={statusFilter === 'inactive' ? { background: '#ea4335', color: '#fff' } : {}}
