...
export default function SettingsPage() {
  ...
  // Super Admin credentials are managed outside this page; do not expose
  // username/password mutation controls in the global settings UI.
  const accountSection = !isMailbox && !isSuper ? (
  ...
  return (
    <GmailShell>
      ...
      <ConfirmDialog
        ...
        message={t('msg.settings.resetConfirm')}
        confirmLabel={t('settings.resetDefault')}
